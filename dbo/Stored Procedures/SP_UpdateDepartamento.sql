				...
				------------------------------ RECORRIDO Y SETEO DE DATA DE LA TABLA  ------------------------------------
					...
					------------------------------ RESPUESTA A LA APP  ------------------------------------
						...
						(
							...
							, (CASE 
                               WHEN @ROW_Asociados  = 0 
							   THEN 'Se modifico con exito el departamento'
							   WHEN @ROW_Asociados  >=  1 
							   THEN 'No puede desactivar un departamento con áreas, roles o usuarios asociados en estado activo' END)  AS ERROR_MESSAGE_SP
